...
public class AgregarPrendaFrame extends JFrame {
	...
	private void initValues() {
		controller.iniciarCreacionPrenda();
	...
	private void addEventListeners() {
		...
		btnAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (controller.agregarPrenda(nombre.getText(), descripcion.getText(), Integer.parseInt(stock.getText()))) {
					dispose();
				} else {
