...
public class ModificarPrendaFrame extends JFrame {
	...
	public ModificarPrendaFrame(int codigo) {
		this.codigo = codigo;
	...
	private void addEventListeners() {
		...
		btnAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (controller.modificarPrenda(codigo, nombre.getText(), descripcion.getText(), seleccionadosModel.getMateriales())) {
					dispose();
				} else {
